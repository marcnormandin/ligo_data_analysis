...
void do_work(size_t num_time_samples, stationary_phase_workspace_t *sp_lookup, gsl_complex *spa, asd_t *asd, gsl_complex *whitened_data, gsl_complex *temp, gsl_complex *out_c);
